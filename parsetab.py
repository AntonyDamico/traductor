...
_lr_productions = [
  ...
  ('statement -> declarations','statement',1,'p_declarations','parser.py',54),
  ('statement -> expr','statement',1,'p_expr_statement','parser.py',59),
  ('declarations -> VAR ID ASSIGN expr','declarations',4,'p_variables','parser.py',68),
  ('declarations -> VAR ID ASSIGN relexpr','declarations',4,'p_variables','parser.py',69),
  ('declarations -> VAR ID','declarations',2,'p_variables','parser.py',70),
  ('command -> WRITE LPAREN expr RPAREN','command',4,'p_write','parser.py',82),
  ('command -> WRITE LPAREN relexpr RPAREN','command',4,'p_write','parser.py',83),
  ('command -> WHILE LPAREN expr RPAREN LBRACKET S RBRACKET','command',7,'p_command_while','parser.py',88),
  ('command -> WHILE LPAREN relexpr RPAREN LBRACKET S RBRACKET','command',7,'p_command_while','parser.py',89),
  ('command -> FOR LPAREN declarations END_LINE relexpr END_LINE expr RPAREN LBRACKET S RBRACKET','command',11,'p_command_for','parser.py',94),
  ('command -> IF LPAREN relexprgroup RPAREN LBRACKET S RBRACKET','command',7,'p_if','parser.py',107),
  ('command -> IF LPAREN relexprgroup RPAREN LBRACKET S RBRACKET ELSE command','command',9,'p_if','parser.py',108),
  ('command -> IF LPAREN relexprgroup RPAREN LBRACKET S RBRACKET ELSE LBRACKET S RBRACKET','command',11,'p_if','parser.py',109),
  ('expr -> expr PLUS expr','expr',3,'p_binary_expression','parser.py',129),
  ('expr -> expr MINUS expr','expr',3,'p_binary_expression','parser.py',130),
  ('expr -> expr TIMES expr','expr',3,'p_binary_expression','parser.py',131),
  ('expr -> expr DIVIDE expr','expr',3,'p_binary_expression','parser.py',132),
  ('expr -> expr MOD expr','expr',3,'p_binary_expression','parser.py',133),
  ('expr -> expr INCREMENT','expr',2,'p_unary_expressions','parser.py',138),
  ('expr -> expr DECREMENT','expr',2,'p_unary_expressions','parser.py',139),
  ('expr -> ID ASSIGN expr','expr',3,'p_assign_expression','parser.py',144),
  ('expr -> NUMBER','expr',1,'p_number_expression','parser.py',149),
  ('expr -> STRINGS','expr',1,'p_string_expression','parser.py',154),
  ('expr -> ID','expr',1,'p_variable_expression','parser.py',159),
  ('expr -> TRUE','expr',1,'p_variable_expression','parser.py',160),
  ('expr -> FALSE','expr',1,'p_variable_expression','parser.py',161),
  ('relexpr -> expr LT expr','relexpr',3,'p_relational_expressions','parser.py',179),
  ('relexpr -> expr LE expr','relexpr',3,'p_relational_expressions','parser.py',180),
  ('relexpr -> expr GT expr','relexpr',3,'p_relational_expressions','parser.py',181),
  ('relexpr -> expr GE expr','relexpr',3,'p_relational_expressions','parser.py',182),
  ('relexpr -> expr EQUALS expr','relexpr',3,'p_relational_expressions','parser.py',183),
  ('relexpr -> expr NE expr','relexpr',3,'p_relational_expressions','parser.py',184),
  ('relexpr -> NOT expr','relexpr',2,'p_relational_expressions','parser.py',185),
  ('relexprgroup -> relexpr AND relexprgroup','relexprgroup',3,'p_rel_group','parser.py',193),
  ('relexprgroup -> relexpr OR relexprgroup','relexprgroup',3,'p_rel_group','parser.py',194),
  ('relexprgroup -> relexpr','relexprgroup',1,'p_rel_group','parser.py',195),
  ('relexprgroup -> expr','relexprgroup',1,'p_rel_group','parser.py',196),
]
